...
-- data for table leavemanagement.employee: ~1 rows (approximately)
...
-- data for table leavemanagement.leave_request: ~0 rows (approximately)
...
-- data for table leavemanagement.leave_type: ~0 rows (approximately)
